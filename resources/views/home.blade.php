                ...
                <div class="col ps-4">
                    ...
                    <div class="mt-3 d-flex align-items-center">
                        <div class="col-3">
                            ...
                            <span class="badge rounded-pill border" style="background-color: #0678c8;">Masculin</span>
                            <span class="badge rounded-pill border" style="background-color: #49a4fe;">Féminin</span>
                        </div>
                        @php
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-6">
                            <div class="card mb-3">
                                <div class="card-header bg-transparent"><i class="bi bi-calendar-event me-2"></i>
                                    Événements
                                </div>
