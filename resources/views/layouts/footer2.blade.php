            ...
            <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
                <div class="w-full mb-10">
                    <a href="javascript:void(0)" class="mb-6 inline-block max-w-[160px]">
                        <img src="/logo.png" alt="logo" class="max-w-full dark:hidden" />
                        <img src="/logo.svg" alt="logo" class="max-w-full hidden dark:block" />
                    </a>
                    <p class="text-base text-body-color dark:text-dark-6 mb-7">
                        Institut Supérieur d'Excellence en Santé de Touba
                    </p>
            ...
            <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                <div class="w-full mb-10">
                    ...
                    <ul class="space-y-3">
                        ...
                        {{-- <li><a href="{{getNavHref($child)}}">{{ $child['label'] }}</a></li> --}}
