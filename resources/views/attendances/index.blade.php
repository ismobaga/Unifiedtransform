...
<div class="container">
    <div class="row justify-content-start">
        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3"><i class="bi bi-calendar2-week"></i> {{ __('attendance.attendance') }}
                    </h1>
                    <div class="row">
                        <div class="col">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="card my-3">
                                        ...
                                        <div class="card-body text-dark">
                                            ...
                                            <h6>
                                                {{ __('attendance.course') }}: {{$course->course_name}}
                                            </h6>
                                            ...
                                            <div class="tab-content">
                                                <div class="accordion" id="accordionClass{{$school_class->id}}">
                                                    @foreach ($classes_and_sections['school_sections'] as
                                                    $school_section)
